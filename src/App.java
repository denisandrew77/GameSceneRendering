...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(movingCharacter4.getPosition().getX()+" "+movingCharacter4.getPosition().getY() );
        ...
        System.out.println(movingCharacter5.getPosition().getX()+" "+movingCharacter5.getPosition().getY() );
        ...
        System.out.println(movingCharacter6.getPosition().getX()+" "+movingCharacter5.getPosition().getY() );
